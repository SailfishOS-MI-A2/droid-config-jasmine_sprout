# DisplayName: Jolla jasmine_sprout/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: jasmine_sprout
# DeviceVariant: jasmine_sprout
# Brand: Jolla
...
repo --name=adaptation-community-common-jasmine_sprout-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration jasmine_sprout
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/jasmine_sprout
...
if [ ! -d ../hybris/hybris-installer/ ]; then
	git clone --depth 1 https://github.com/nebrassy/hybris-installer.git ../hybris/hybris-installer > /dev/null
fi
